...
import com.zhouyi.myblog.dao.CommentRepository;
...
//        return commentRepository.findByBlogId(blogId, new Sort(Sort.Direction.DESC, "createTime"));
//    }
    @Override
    public List<Comment> listCommentByBlogId(Long blogId) {
        List<Comment> comments = commentRepository.findByBlogIdAndParentCommentNull(blogId, new Sort(Sort.Direction.DESC, "createTime"));
